let ItemCreator = (function() { // constructor function iife
  function generateSKU(itemName, category) { // private methods
    let sku = '';
  ...
  return function(name, category, quantity) { // explicit return function
...
let ItemManager = (function() {
  return {
    items: [], // contains ItemCreator objects that can use private ItemManager methods

    create(name, category, quantity) {
      let newItem = new ItemCreator(name, category, quantity); // use new to create object from ItemCreator constructor
      if (newItem.notValid) {
        return false
      } else {
...
let ReportManager = (function() {
  return {
    init(object) {
      this.items = object; // save ItemManager object to items (gives us access to items array of objects and methods)
      return this;
    },
